...
namespace PlanetGeneration
{
    ...
    public class BiomeData : ScriptableObject
    {
        ...
        [Header("Surface Details (Visuals)")]
        ...
        [Tooltip("Direction defines the axis. Length defines the stretch amount.")]
        ...
        public GPUBiome ToGPUBiome(float assignedThreshold)
        {
            return new GPUBiome(
