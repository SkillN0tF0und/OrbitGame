...
namespace OrbitGame.Core {
    public struct Vector3d {
        ...
        // --- ADD THESE TO VECTOR3D.CS ---

        public static Vector3d RotateAroundX(Vector3d v, double angleRadians)
        {
            double cos = Mathd.Cos(angleRadians);
            double sin = Mathd.Sin(angleRadians);
            return new Vector3d(
                v.x,
                v.y * cos - v.z * sin,
                v.y * sin + v.z * cos
        ...
        public static Vector3d RotateAroundY(Vector3d v, double angleRadians)
        {
            double cos = Mathd.Cos(angleRadians);
            double sin = Mathd.Sin(angleRadians);
            return new Vector3d(
        ...
        public static Vector3d RotateAroundZ(Vector3d v, double angleRadians)
        {
            double cos = Mathd.Cos(angleRadians);
            double sin = Mathd.Sin(angleRadians);
            return new Vector3d(
